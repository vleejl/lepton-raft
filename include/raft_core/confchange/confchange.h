...
class changer {
 ...
 private:
  ...
  // state.
  leaf::result<void> apply(absl::Span<const raftpb::ConfChangeSingle *const> ccs, tracker::config &cfg,
 ...
 public:
  ...
  result enter_joint(bool auto_leave, absl::Span<const raftpb::ConfChangeSingle *const> ccs) const;
  ...
  result simple(absl::Span<const raftpb::ConfChangeSingle *const> ccs) const;
