...
struct storage_builer : pro::facade_builder 
  ...
  ::add_convention<storage_entries, leaf::result<std::span<raftpb::entry>>(std::uint64_t lo, std::uint64_t hi, std::uint64_t max_size)> 
  ...
  ::add_convention<storage_snapshot, leaf::result<raftpb::snapshot>()> 
