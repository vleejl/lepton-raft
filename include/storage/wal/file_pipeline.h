...
class file_pipeline {
 ...
 public:
  ...
  asio::awaitable<expected<fileutil::locked_file_endpoint_handle>> open();

 private:
  leaf::result<fileutil::locked_file_endpoint_handle> alloc();
 ...
 private:
  ...
  coro::channel_endpoint<expected<fileutil::locked_file_endpoint_handle>> file_chan_;
  // dir to put files
